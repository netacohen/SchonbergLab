...
%!!!!!!!!!!! The line I (Rani) used for probe: createOnsetList(3,1,10,1,70,15,4)!!!!!!!!
%!!!!!!!!!!! The line I (Rani) used for probe after the change: createOnsetList(3.5,1,7,1,143,27,4)!!!!!!!!
%!!!!!!!!!!! The FINAL line I (Rani) used for probe after the change: createOnsetList(3.5,1.5,11.5,0.5,143,27,4)
%!!!!!!!!!!! The MORE FINAL line I (Rani) used for probe after the change: createOnsetList(3.5,1.5,11.5,0.5,291.5,54,4)
%!!!!!!!!!!! The MORE MORE FINAL line I (Rani) used for probe after the change: createOnsetList(3.5,1.5,8,0.5,258.5,48,4)
...
% createOnsetList(3,2,7,1,75,16,2) + 2
% createOnsetList(MeanJitter,2,7,1,(MeanJitter+2)*(NumberOfFractals-1),NumberOfFractals,NumOfOnsetsLists)
...
% requiredLength 336 (5*(68-1)+1 for pair number ---> mean length of one trial*(number of trials per run-1)+1 for paired number) (and them when adding 2 to the diff matrix we get mean 5, min 3, max 14, interval 1),
