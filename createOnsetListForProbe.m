function onsetlist = createOnsetListForProbe(mean_t,min_t,max_t,interval,requiredLength,numTrials)
% -------------------------------------
% Edited by Rani Gera 25/01/17
% Based on the code created by Rotem Botvinik 4/12/14
% and edited by her 11/12/14
% -------------------------------------

% function onsetlist = createOnsetListForProbe(mean_t,min_t,max_t,interval,requiredLength,numTrials)
% Creates onsetlist vector for the probe of the cue approach task.
